...
public class PreferenceEntity implements Serializable {
    ...
    private boolean preferenceOn;
    private String preferenceFile;

    public PreferenceEntity() {
    }

    public PreferenceEntity(String preferenceName) {
    ...
    public boolean isPreferenceOn() {
        return preferenceOn;
    }

    public void setPreferenceOn(boolean preferenceOn) {
        this.preferenceOn = preferenceOn;
    }
    ...
    public String toString() {
        return "com.arnowouter.entities.Preferences[ id=" + id + " ]";
    }
