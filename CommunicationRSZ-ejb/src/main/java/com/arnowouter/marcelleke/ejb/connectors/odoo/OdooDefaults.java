...
public class OdooDefaults {
   ...
   // ACTIONS
    ...
    // MODELS
    //  BADGER MODELS
    //  TODO: Change to the Badger-odoo module! (now using (Isoltrack) 
    public final static String MODEL_BADGER_SESSION = "isoltrack.session";
    public final static String MODEL_BADGER_LOG = "isoltrack.log";
    ...
    public final static String MODEL_SALES_TEAM = "crm.case.section";
    public final static String MODEL_WORK_ORDERS = "project.task.work";
    // FIELDS
    // FIELDS
    ...
    public final static String FIELD_TASK_SUMMARY = "name";
    public final static String FIELD_LAST_UPDATED_ON = "write_date";
    public final static String FIELD_WORK_ORDER = "workorder";
    public final static String FIELD_KANBAN_STATE ="kanban_state";
